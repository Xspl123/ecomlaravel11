...
<main class="pt-90">
    ...
    <section class="product-single container">
        <div class="row">
                        ...
                        <div class="swiper-container">
                            <div class="swiper-wrapper">
                                <div class="swiper-slide product-single__image-item">
                                    <img loading="lazy" class="h-auto" src="{{ asset('uploads/products/thumbnails') }}/{{$products->image}}" width="674" height="674" alt="" />
                                    <a data-fancybox="gallery" href="{{ asset('uploads/products/thumbnails') }}/{{$products->image}}" data-bs-toggle="tooltip" data-bs-placement="left" title="Zoom">
                                ...
                                <div class="swiper-container background-img js-swiper-slider" data-settings='{"resizeObserver": true}'>
                                    <div class="swiper-wrapper">
                                        <div class="swiper-slide product-single__image-item">
                                            <img loading="lazy" class="h-auto" src="{{ asset('uploads/products/thumbnails/' . $products->image) }}" width="674" height="674" alt="{{ $products->name }}" />
                                            <a data-fancybox="gallery" href="{{ asset('uploads/products/thumbnails/' . $products->image) }}" data-bs-toggle="tooltip" data-bs-placement="left" title="Zoom">
                                                <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <use href="#icon_zoom" />
                                                </svg>
                                        ...
                                        @php
                                        // Decode the JSON string to get an array of image names
                                        $images = json_decode($products->gallery_images, true);
                                        @endphp
                                        ...
                                        @endphp
                                        <div class="swiper-slide product-single__image-item">
                                            <img loading="lazy" class="h-auto" src="{{ asset('uploads/products/' . $gimg) }}" width="674" height="674" alt="{{ $products->name }}" />
                    ...
                    <div class="product-single__thumbnail">
                        <div class="swiper-container">
                            <div class="swiper-wrapper">
                                <!-- Main product image -->
                                <div class="swiper-slide product-single__image-item">
                                    <img loading="lazy" class="h-auto" src="{{ asset('uploads/products/thumbnails/' . $products->image) }}" width="104" height="104" alt="{{ $products->name }}" />
                                </div>
                                ...
                                @endphp
                                <div class="swiper-slide product-single__image-item">
                                    <img loading="lazy" class="h-auto" src="{{ asset('uploads/products/' . $gimg) }}" width="104" height="104" alt="{{ $products->name }}" />
                                </div>
                                @endforeach
                                @endif
                            </div>
            ...
            <div class="col-lg-5">
                ...
                <a href="{{route('cart.index')}}" class="btn btn-warning">Go to Cart</a><br>
                @else
                <!-- Add Cart -->
   ...
   <section class="products-carousel container">
    <h2 class="h3 text-uppercase mb-4 pb-xl-2 mb-xl-4">Related <strong>Productsfff</strong></h2>
   <div id="related_products" class="position-relative">
    <div class="swiper-container js-swiper-slider">
        <!-- Swiper settings are configured via JavaScript, not data-attributes -->
        <div class="swiper-wrapper">
            ...
            <div class="swiper-slide product-card">
                <div class="pc__img-wrapper">
                    <a href="{{ route('shop.product_details', ['product_slug' => $rproduct->slug]) }}">
                        ...
                        @php
                        $images = json_decode($rproduct->gallery_images, true);
                        @endphp
                        @foreach ($images as $gimg)
                        @php
                        $gimg = trim($gimg, '[]"');
                        @endphp
                        <img loading="lazy" src="{{ asset('uploads/products/' . $gimg) }}" class="pc__img" alt="{{ $rproduct->name }}">
                        @endforeach
                    </a>
                ...
                <div class="pc__info position-relative">
                    ...
                    <h6 class="pc__title"><a href="{{ route('shop.product_details', ['product_slug' => $rproduct->slug]) }}">{{ $rproduct->name }}</a></h6>
